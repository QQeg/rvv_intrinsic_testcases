 ...
 * However, gem5 incorrectly output 32 instead of 0.
 */
#include <stdint.h>
#include <stdio.h>
...
int main() {
    int8_t print_buffer[1];
    size_t vl = 1;

    vint8m1_t Vs1 = vmv_v_x_i8m1(1, vl);
    vse8_v_i8m1(print_buffer, Vs1, vl);
    printf("Vs1[0] = %-3d \n", print_buffer[0]);

    vint8m1_t Vd = vsadd_vx_i8m1(Vs1, -1, 1);
    vse8_v_i8m1(print_buffer, Vd, vl);
    printf("Vd [0] = %-3d \n", print_buffer[0]);
